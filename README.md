...
| 竖版|斜体 | 支持 | 支持倾斜文字翻译 |
| 多行文本合并 | 支持 | 支持段落式、多行文字合并翻译 |
| 商品文字保护 | 支持 | 支持识别商品上的文字，可选择翻译或者不翻译 |
| 图片更清晰 | 支持 | 支持对低分辨率的图片自动清晰处理 |
| 批量处理 | 支持 | 支持批量处理 |
| 精细编辑 | 支持 | 支持精细化编辑器，对翻译后的字体、位置、样式调整 |
| 翻译引擎 | 支持 | 支持讯飞、deepl、chatgpt、google等 |
| 支持语种 | 100+种语言互译，包括中文、英文、日文、韩语、泰文、越南文、阿拉伯语等 |  |
| 支持格式 | JPG、PNG、BMP、WEBP、GIF等|  |
...
目前招鲤科技提供的免费的在线软件，同时支持**AI图片翻译接口和私有化部署方案**，
私有化包括上述所有功能：图片擦除+图片翻译功能及其后续更新维护。
